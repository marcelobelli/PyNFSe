...
@pytest.mark.parametrize('tipo_documento,numero_documento', (
    ('CNPJ', '12345678901234'),
    ('CPF', '12345678901'),
))
...
@pytest.mark.parametrize('valor_servico,valor_deducoes,desconto_incondicionado', (
    ('100.00', '10.00', '10.00'),
    ('50.00', '9.00', '5.00'),
))
...
@pytest.mark.parametrize('valor_servico,aliquota_iss', (
    ('100.00', '0.02'),
    ('50.00', '0.05'),
    ('76.00', '0.07'),
))
...
@pytest.mark.parametrize('iss_retido,valor_iss_retido', (
    (1, '2.00'),
    (2, '0'),
))
