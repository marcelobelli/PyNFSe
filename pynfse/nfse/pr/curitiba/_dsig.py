...
class ObjectType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _HasWildcardElement = True
    _ElementMap.update({})
    _AttributeMap.update({__Id.name(): __Id, __MimeType.name(): __MimeType, __Encoding.name(): __Encoding})
...
def _BuildAutomaton_3():
    ...
    symbol = pyxb.binding.content.WildcardUse(
        pyxb.binding.content.Wildcard(
            process_contents=pyxb.binding.content.Wildcard.PC_strict,
            namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, "http://www.w3.org/2000/09/xmldsig#"),
        ),
        pyxb.utils.utility.Location(
            "/Users/Marcelo/Dev/Projetos/PyNFSe/PyNFSe/XSD/Curitiba/Template/xmldsig-core-schema20020212.xsd",
            86,
...
def _BuildAutomaton_17():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        SignaturePropertiesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "SignatureProperty")),
        pyxb.utils.utility.Location(
            "/Users/Marcelo/Dev/Projetos/PyNFSe/PyNFSe/XSD/Curitiba/Template/xmldsig-core-schema20020212.xsd",
            262,
            4,
